...
public class Game {
	...
	private String[] botNames = { "Laika", "Charles Babbage", "Alan Turing", "Ada Lovelace", "Ghost of RPS",
			"Someone You Know", "Diogenes", "Chris Sawyer", "Jon Skeet" };
	...
	private void displayString() {
		System.out.println(
				userName + " " + Integer.toString(playerScore) + " - " + Integer.toString(aiScore) + " " + botName);
